 ...
 * Pre_ordine Gateway
 *
 * Provides a Pre_ordine.
 *
 * @class 		WC_Gateway_Pre_ordine
...
class WC_Gateway_Pre_ordine extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_title       = __( 'Pre_ordine', 'woocommerce' );
    ...
    public function init_form_fields() {
    	...
    	$this->form_fields = array(
			'enabled' => array(
				...
				'type'    => 'checkbox',
				'label'   => __( 'Enable Pre_ordine Payment', 'woocommerce' ),
				'default' => 'yes'
			),
			'title' => array(
				...
				'default'     => __( 'Pre_ordine Payment', 'woocommerce' ),
				'desc_tip'    => true,
			),
			'description' => array(
				...
				'default'     => __( 'Please send your pre_ordine to Store Name, Store Street, Store Town, Store State / County, Store Postcode.', 'woocommerce' ),
				'desc_tip'    => true,
			),
			'instructions' => array(
