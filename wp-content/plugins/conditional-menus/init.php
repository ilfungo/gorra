...
class Themify_Conditional_Menus {
	...
	public function get_visibility_options( $selected = array() ) {
		$post_types = apply_filters( 'themify_cm_conditions_post_types', get_post_types( array( 'public' => true ) ) );
		$post_types = array_map( 'get_post_type_object', $post_types );
		$taxonomies = apply_filters( 'themify_cm_conditions_taxonomies', get_taxonomies( array( 'public' => true ) ) );
